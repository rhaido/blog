...
Also, [there is nice series about desoldering](), also from PACE and also very
useful: I've learnt some techniques and tricks from it.
...
are featured and praised by the Internet and experts, but absence of them does not
...
I can only repeat what has already been stated in the video: there are so many
...
continuous bare non-fluxed copper strips of 2.2mm width.
...
## Keep It Simple with Mains Iron
...
In case you need to solder more massive stuff, there are more powerful models
from the same manufacturers, with temperature of the tip above 400 degrees in
case you need to solder bigger joints:
...
... and a little bit more to make sure, that iron is hot enough and its tip and
heating element are fully "loaded". This detail is frequently omitted by
beginners - I was not an exclusion - while using classical irons. While some
manufacturers honestly specify "5 minutes" of heating time, most of them do not
really bother too much.  Physical dimensions of the tip also contribute to the heating
time: bigger/thicker/heavier your tip is, more time is required to heat up the
whole system properly.

I usually turn the iron on, put on work clothes, go to get some water to wet
sponge, do some other small preparations - and voila, it is already hot and
ready to to solder!

## Power-On/Power-Off
Once I have encountered an instruction for some university electronics laboratory,
where I have found the following statement: "Tools like CRT oscilloscope
...
really want should be made out of 100% cell, and it should be hard and 
dense in a dry state; otherwise you are risking to kill the tip of your soldering iron!

## Stand Up or Lay Down? Stand as a Radiator?
It looks like as there is a small fight about this subject as well: should the
iron be placed horizontally, or with the tip slightly above the handle, or
should it be a diagonal placement, like in a normal stand. Personally I think,
that if it makes any difference, it is almost negligible. I use simple ST4
stand from Antex, and my iron is slightly "pulled-off" the stand to prevent
handle getting hot. Also, tip of my soldering iron usually touches the metal
spring, thus working as a heatsink, which _I believe_ help to reduce tip wear
(although more evidence is necessary to collect here).

## Leaded vs Lead-free
Funny enough, today for amateurs and for high reliability soldering the answer
is the same: **leaded solder**.  Lead-free fluxes are more toxic, and it is
**FLUX** - not a metal compound itself - which is posing the main danger to
you while soldering. For for medical, military and aeronautic purposes, where
the quality of soldering connections is critical, the leaded solder is
obligatory: [read more about
whiskers](https://en.wikipedia.org/wiki/Whisker_%28metallurgy%29).  Also,
...
As a beginner, I started with lead-free and struggled a lot with it; managed at the
end, but wasted a lot of time to produce solder joints of a reasonable quality.
Today, leaded solder dominates my storage and I try to work only with it.

There is a number of solder manufacturers, which are accepted as an industry
standards: Kester, MG Chemicals, Multicore, Edsyn, Elsold, various
Japanese manufacturers, and so on - stick to them.  Compound wise, I would only
use and recommend 63/37 (Sn/Pb) or 62/36/2 (Sn/Pb/Ag) solder nowadays, as it is
better then 60/40 in every respect, as far as I am aware; only if you can not
get one - use very traditional 60/40 solder.

## Solder Wire Diameter
Obviously, thicker wire will have more solder per unit of length
- therefore, with thinner wire you have a finer control over
the process (you spend less wire per unit of length _and_ per unit of time).
Its diameter should be something between 0.35mm and 0.5mm. As a general rule,
try to avoid extremes: do not use neither too small, as you probably
do not want to feed 10 cm of wire per joint, nor too big for the opposite
reasons (creation of a solder blob with 1 mm of solder).

Start with a small spool of 0.4mm or 0.5mm solder wire and see, if it is OK or
not, and then decide in what direction to move.
...
story different.  Sometimes there is plenty of flux already in the solder wire.
But overall, even if you clean bare copper with the alcohol, you still have
to use flux, as the copper itself tend to oxidise quite fast.
